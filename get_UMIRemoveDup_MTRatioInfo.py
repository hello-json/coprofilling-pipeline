...
outFileDir = "/home/sw2448/palmer_scratch/data/spatialSingleCellEachCloneVariantCluter_project/process_data/" + sampleName + "/cells/MTRatioResult/"
os.system("mkdir " + outFileDir)
outFile = outFileDir + "finalMTRatio.tsv"
