...
output_tsv = '/home/sw2448/project/spatialSingleCellEachCloneVariantCluter_project/codeAndShell/getPerBinFragments/MBDNA.tsv'
window = 100000
...
# 创建标题行，第一列是spot，后面是bin1到bin631
columns_in_row = len(filtered_results[0])
header = ['spot'] + [f'bin{i}' for i in range(1, columns_in_row)]
